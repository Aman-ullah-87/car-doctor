...
const Navbar = () => {
  ...
  <div className="navbar-start">
    ...
    <Link to='/'><img className="w-[107px] h-[87px]" src={logo} alt="" /></Link>
  </div>
  ...
  <button className="btn btn-outline text-primary hover:bg-primary hover:border-white">Appointment</button>
  </div>
</div>
    );
};
